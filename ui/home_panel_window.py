...
################################################################################
## Form generated from reading UI file 'designerTHUgZC.ui'
##
...
class Ui_WorkspacePanelWindow(object):
    def setupUi(self, WorkspacePanelWindow):
        ...
        WorkspacePanelWindow.resize(647, 444)
        ...
        WorkspacePanelWindow.setStyleSheet(u"background: rgb(53, 75, 98)")
        ...
        self.createXMLDocBtn.setGeometry(QRect(220, 370, 121, 41))
...
"color: rgb(242, 255, 245)")
        ...
        self.createWorkspaceBtn.setGeometry(QRect(220, 110, 121, 41))
...
"color: rgb(242, 255, 245)")
        ...
        self.frame_2.setGeometry(QRect(50, 240, 301, 121))
...
"font-size: 15px;\n"
"border: 0.5px solid rgb(70, 70, 70);\n"
"background: rgba(206, 227, 232, 150);\n"
"border-radius: 10px;\n"
"padding: 2px;\n"
"color: rgb(242, 255, 245)")
...
"color: rgb(242, 255, 245)")
        ...
        self.frame_5.setGeometry(QRect(0, 0, 261, 441))
        self.frame_5.setStyleSheet(u"background: rgba(177, 200, 194, 100)")
        self.frame_5.setFrameShape(QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QFrame.Raised)
        self.openBtn = QToolButton(self.frame_5)
        self.openBtn.setObjectName(u"openBtn")
        self.openBtn.setGeometry(QRect(70, 280, 121, 41))
